...
import { miscellaneousServicesData } from './miscellaneousServices';

interface MiscellaneousServicesScreenProps {
  setScreen: (screen: Screen) => void;
}

const MiscellaneousServicesScreen: React.FC<MiscellaneousServicesScreenProps> = ({ setScreen }) => {
    const goBack = () => {
...
export default MiscellaneousServicesScreen;