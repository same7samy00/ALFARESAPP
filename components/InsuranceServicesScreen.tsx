...
import { insuranceServicesData, InsuranceCategory } from './insuranceServices';

interface InsuranceServicesScreenProps {
  setScreen: (screen: Screen) => void;
}

const InsuranceServicesScreen: React.FC<InsuranceServicesScreenProps> = ({ setScreen }) => {
    ...
    const handleCategorySelect = (category: InsuranceCategory) => {
                ...
                return (
                    <main className="flex-grow p-4 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-3">
                            {insuranceServicesData.map(category => (
...
export default InsuranceServicesScreen;