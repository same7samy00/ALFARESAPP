...
import { installmentsLoansServicesData, LoanCategory } from './installmentsLoansServices';

interface InstallmentsLoansScreenProps {
  setScreen: (screen: Screen) => void;
}

const InstallmentsLoansScreen: React.FC<InstallmentsLoansScreenProps> = ({ setScreen }) => {
    ...
    const handleCategorySelect = (category: LoanCategory) => {
                ...
                return (
                    <main className="flex-grow p-4 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-3">
                            {installmentsLoansServicesData.map(category => (
...
export default InstallmentsLoansScreen;