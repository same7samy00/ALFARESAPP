...
import { subscriptionsServicesData, SubscriptionCategory, SubscriptionSubCategory } from './subscriptionsServices';

interface SubscriptionsDonationsScreenProps {
  setScreen: (screen: Screen) => void;
}

const SubscriptionsDonationsScreen: React.FC<SubscriptionsDonationsScreenProps> = ({ setScreen }) => {
    const [step, setStep] = useState(1);
    const [selectedCategory, setSelectedCategory] = useState<SubscriptionCategory | null>(null);
    const [selectedSubCategory, setSelectedSubCategory] = useState<SubscriptionSubCategory | null>(null);
    ...
    const handleSubCategorySelect = (subCategory: SubscriptionSubCategory) => {
                ...
                return (
                    <main className="flex-grow p-4 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-3">
                            {subscriptionsServicesData.map(category => (
...
export default SubscriptionsDonationsScreen;
