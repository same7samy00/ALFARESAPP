...
import { financialServicesData, FinancialCategory } from './financialServices';

interface FinancialTransactionsScreenProps {
  setScreen: (screen: Screen) => void;
}

const FinancialTransactionsScreen: React.FC<FinancialTransactionsScreenProps> = ({ setScreen }) => {
    ...
    const handleCategorySelect = (category: FinancialCategory) => {
                ...
                return (
                    <main className="flex-grow p-4 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-3">
                            {financialServicesData.map(category => (
